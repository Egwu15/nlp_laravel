...
{
    protected static ?string $model = CourtRule::class;
    ...
    {
        return [
            'index' => Pages\ListCourtRules::route('/'),
            'create' => Pages\CreateCourtRule::route('/create'),
            'edit' => Pages\EditCourtRule::route('/{record}/edit'),
        ];
    }
}
